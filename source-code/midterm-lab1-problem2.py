...
while since we last we spoke, and I wanted to catch up with you.\nLet's plan
to meet up soon and have a great time together!"
subj_name = "Jane"
sender_name = "Jane"
ver_num = 1.2
discount = 10.50
...
print("Status: %c\nCode: %s\nLocation: %s\nAge: %d\nCompany: %s\nWebsite:
%s\nPhone: %s\nJob Tittle: %s\nDepartment: %s"%
(status,code,loc_name,_age,company_name,web_name,phone_num,job_title,depart_n
ame))
